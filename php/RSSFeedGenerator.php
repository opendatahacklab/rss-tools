<?php 
/**
 * An utility to produce rss 2.0 feeds.
 * 
...
class RSSFeedGenerator{
	 ...
	 * @param boolean $ccLicense add a creative commons license indication
	 * @return number
	 */
	public function __construct($title, $description,  $homepage, $url, $ccLicense) {
